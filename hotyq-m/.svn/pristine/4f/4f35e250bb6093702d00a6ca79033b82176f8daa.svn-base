...
module.exports = {
  ...
  module: {
	    loaders: [{
	        ...
	        test: /\.scss$/,
	        exclude: /(node_modules|bower_components)/,
	        loader: "style!css?modules&importLoaders=2&camelCase&localIdentName=[local]___[hash:base64:5]!autoprefixer?browsers=last 100 versions!sass"
