  ...
  render() {
    ...
    return (
		<div className="companyHistory">
        		<div className="companyHistoryItem">
        			<div className="companyHistoryItemYear">2014年</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2014年10月</div>
	        			<p>创始人鲍啸峰、姜海、大姨吗CEO柴可等人筹资120万，红演圈（北京）网络科技有限公司成立。</p>
        			</div>
        		</div>
        		<div className="companyHistoryItem">
        			<div className="companyHistoryItemYear">2015年</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2015年4月</div>
	        			<p>红演圈科技获海通证券1400万天使轮投资。</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2015年5月</div>
	        			<p>红演圈App作为一款具有社交功能的演艺圈“智联招聘”，iOS 1.0、Android 1.0正式上线。</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2015年8月</div>
	        			<p>红演圈科技联合Chinajoy主办方汉威信恒，开展2015 China Showgirl网络海选暨年度盛典活动，千余名showgirl报名，数百万网友参与投票，反响热烈。同期，注册用户突破50万。</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2015年9月</div>
	        			<p>红演圈（亚洲）有限公司在香港成立，布局港澳台和日韩娱乐艺人服务。香港亚洲电视指定红演圈为第27届ATV2015亚洲小姐竞选中国内地独家网络海选官方合作平台。</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2015年10月</div>
	        			<p>红演圈科技成为世界超模中国冠军赛海选北京赛区官方合作平台。</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2015年11月</div>
	        			<p>红演圈科技与CCTV6电影频道1905电影网达成战略合作，共同组建运营公司，运营电影网“优才计划”。</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2015年12月</div>
	        			<p>红演圈科技获赛马资本A轮2100万人民币投资。</p>
        			</div>
        		</div>
        		
        		<div className="companyHistoryItem">
        			<div className="companyHistoryItemYear">2016年</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2016年2月</div>
	        			<p>红演圈科技联合微博校园、腾讯视频、女神TV等共同举办校园艺人排行榜活动，为有演艺梦想的校园艺人提供展示平台。</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2016年5月</div>
	        			<p>红演圈科技联合新浪微博、乐视影业、猎聘网、新东方在线等100家企业，共同成立中国校园市场联盟。红演圈科技连同微博校园、乐视影业、支付宝、OPPO等企业出任联席主席单位。
</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2016年5月</div>
        			...
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2016年6月</div>
        			...
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2016年7月</div>
        			...
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2016年8月</div>
	        			<p>红演圈科技和新媒诚品影业（股票代码：834522）合资成立新媒红贩（北京）网络科技有限公司，运营线上线下一体化的影游IP交易平台红贩。同月，红贩App上线。</p>
        			</div>
        			<div className="companyHistoryItemCons">
	        			<div className="companyHistoryItemDate">2016年9月</div>
